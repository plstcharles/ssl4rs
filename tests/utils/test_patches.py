...
def test_patch_coord():
    coords = patches.PatchCoord((0, 1), bottom_right=(5, 7))
    ...
    coords2 = patches.PatchCoord((0, 1), shape=(5, 6))
    ...
    coords3 = patches.PatchCoord((1, 1), shape=(5, 6))
    assert coords != coords3
    with pytest.raises(AssertionError):
        _ = patches.PatchCoord((0, 0), (5, 5))
    with pytest.raises(AssertionError):
        _ = patches.PatchCoord(top_left=(0, 0), bottom_right=(5, 5), shape=(5, 5))


def test_patch_coord_contains_and_intersects():
    rect1 = patches.PatchCoord((5, 10), shape=(10, 10))  # 10x10 rect between (5,10) and (15,20)
